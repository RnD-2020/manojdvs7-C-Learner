...
namespace spec
{
	...
	public:
		...
		void Test_isEven()
		{
			Assert::AreEqual(0x1, isEven(2), L"isOdd(2) failed", 1, 2);
			Assert::AreEqual(0x1, isEven(4534), L"isOdd(4534) failed", 1, 2);
			Assert::AreEqual(0x0, isEven(2341), L"isOdd(2341) failed", 1, 2);
			Assert::AreEqual(0x0, isEven(689), L"isOdd(689) failed", 1, 2);
		};
        ...
        void Test_reverseOfNumberByByte()
        {
            ...
            Assert::AreEqual(0x0, reverseOfNumberByByte(0), L"reverseOfNumberByByte(0) failed", 1, 2);
        };
	};
}
